...
login_heading.grid(row=1, column=0, pady=(20, 0), padx=40, sticky="n")
username_entry = ctk.CTkEntry(login_frame, placeholder_text="Benutzername")
username_entry.grid(row=2, column=0, pady=(20, 0), padx=40, sticky="n")
password_entry = ctk.CTkEntry(login_frame, placeholder_text="Passwort", show="•")
password_entry.grid(row=3, column=0, pady=(20, 0), padx=40, sticky="n")
login_button = ctk.CTkButton(login_frame, text="Einloggen", command=login)
login_button.grid(row=4, column=0, pady=20, padx=40, sticky="n")
